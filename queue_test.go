...
func TestConnections(t *testing.T) {
	flushConn, err := OpenConnection("conns-flush", "tcp", "localhost:30001", 1, nil)
	...
	connection, err := OpenConnection("conns-conn", "tcp", "localhost:30001", 1, nil)
	assert.NoError(t, err)
	...
	conn1, err := OpenConnection("conns-conn1", "tcp", "localhost:30001", 1, nil)
	assert.NoError(t, err)
	connections, err = connection.getConnections()
	assert.NoError(t, err)
	...
	conn2, err := OpenConnection("conns-conn2", "tcp", "localhost:30001", 1, nil)
	assert.NoError(t, err)
	connections, err = connection.getConnections()
	assert.NoError(t, err)
...
func TestConnectionQueues(t *testing.T) {
	connection, err := OpenConnection("conn-q-conn", "tcp", "localhost:30001", 1, nil)
	assert.NoError(t, err)
	require.NotNil(t, connection)
...
func TestQueueCommon(t *testing.T) {
	connection, err := OpenConnection("queue-conn", "tcp", "localhost:30001", 1, nil)
	assert.NoError(t, err)
	require.NotNil(t, connection)
...
func TestConsumerCommon(t *testing.T) {
	connection, err := OpenConnection("cons-conn", "tcp", "localhost:30001", 1, nil)
	assert.NoError(t, err)
	require.NotNil(t, connection)
...
func TestMulti(t *testing.T) {
	connection, err := OpenConnection("multi-conn", "tcp", "localhost:30001", 1, nil)
	assert.NoError(t, err)
...
func TestBatch(t *testing.T) {
	connection, err := OpenConnection("batch-conn", "tcp", "localhost:30001", 1, nil)
	assert.NoError(t, err)
...
func TestReturnRejected(t *testing.T) {
	connection, err := OpenConnection("return-conn", "tcp", "localhost:30001", 1, nil)
	assert.NoError(t, err)
...
func TestPushQueue(t *testing.T) {
	connection, err := OpenConnection("push", "tcp", "localhost:30001", 1, nil)
	assert.NoError(t, err)
...
func TestStopConsuming_Consumer(t *testing.T) {
	connection, err := OpenConnection("consume", "tcp", "localhost:30001", 1, nil)
	assert.NoError(t, err)
...
func TestStopConsuming_BatchConsumer(t *testing.T) {
	connection, err := OpenConnection("batchConsume", "tcp", "localhost:30001", 1, nil)
	assert.NoError(t, err)
...
func BenchmarkQueue(b *testing.B) {
	// open queue
	connection, err := OpenConnection("bench-conn", "tcp", "localhost:30001", 1, nil)
